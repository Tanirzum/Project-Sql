...
SELECT * FROM customers WHERE country IN ('Germany', 'Berlin', 'Frince')

SELECT * FROM customers WHERE country IN ('Germany', 'Berlin', 'Frince') AND customername LIKE 'A%';

SELECT * FROM customers WHERE customerid BETWEEN 40 AND 50 AND customername LIKE 'L%e';

SELECT * FROM customers WHERE customername BETWEEN 'Bon app' AND 'Ernst Handel' ORDER BY customername DESC;
...
Requests
```sql
SELECT * FROM person INNER JOIN city ON person.city_id = city.id

SELECT * FROM person LEFT JOIN city ON person.city_id = city.id

SELECT * FROM person RIGHT JOIN city ON person.city_id = city.id

SELECT * FROM person FULL JOIN city ON person.city_id = city.id

SELECT name FROM person UNION SELECT name FROM city ORDER BY name;
```
